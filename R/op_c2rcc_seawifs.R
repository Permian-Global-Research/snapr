#' c2rcc.seawifs: snap operator function
...
#' processing Default value is '!(l2_flags.LAND || rhot_865 > 0.25)'.
...
#'
#' "Performs atmospheric correction and IOP retrieval on SeaWifs L1C data
#' products."
#' @import xml2
#' @return snap_op_c2rcc_seawifs object
#' @export
op_c2rcc_seawifs <- function(
    operator_id,
    sourceProduct,
    ncepEndProduct = NULL,
    ...
    validPixelExpression = "!(l2_flags.LAND || rhot_865 > 0.25)",
    salinity = 35.0,
    temperature = 15.0,
    ozone = 330,
    press = 1000,
  ...
  xml_add_child(node, "operator", "c2rcc.seawifs")
  ...
  snap_op_c2rcc_seawifs <- S7::new_class(
    "snap_op_c2rcc_seawifs",
    parent = snap_operator
  )
  snap_op_c2rcc_seawifs(
    operator = "c2rcc.seawifs",
