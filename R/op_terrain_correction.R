...
#' @import xml2
#' @return snap_op_terrain_correction object
#' @export
op_terrain_correction <- function(
    operator_id,
    sourceProduct,
    sourceBands = NULL,
    demName = "SRTM 3Sec",
  ...
  xml_add_child(node, "operator", "Terrain-Correction")
  ...
  snap_op_terrain_correction <- S7::new_class(
    "snap_op_terrain_correction",
