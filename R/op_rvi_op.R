...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the RVI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the RVI computation. If not
...
#'
#' "Ratio Vegetation Index retrieves the Isovegetation lines converge at
#' origin"
#' @import xml2
#' @return snap_op_rvi_op object
#' @export
op_rvi_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "RviOp")
