#' c2rcc.meris: snap operator function
...
#' processing. Default value is '!l1_flags.INVALID && !l1_flags.LAND_OCEAN'.
...
#' @param useDefaultSolarFlux If 'false', use solar flux from source product
#' Default value is 'false'.
#' @param useEcmwfAuxData If selected, the ECMWF auxiliary data (ozon, air
#' pressure) of the source product is used Default value is 'true'.
...
#' MERIS L1b data products."
#' @import xml2
#' @return snap_op_c2rcc_meris object
#' @export
op_c2rcc_meris <- function(
    operator_id,
    sourceProduct,
    ncepEndProduct = NULL,
    ...
    validPixelExpression = "!l1_flags.INVALID && !l1_flags.LAND_OCEAN",
    salinity = 35.0,
    temperature = 15.0,
    ozone = 330,
    press = 1000,
  ...
  xml_add_child(node, "operator", "c2rcc.meris")
  ...
  snap_op_c2rcc_meris <- S7::new_class(
    "snap_op_c2rcc_meris",
    parent = snap_operator
  )
  snap_op_c2rcc_meris(
    operator = "c2rcc.meris",
