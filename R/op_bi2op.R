...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the BI2 computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param greenSourceBand The green band for the BI2 computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the BI2 computation. If not
#' provided, the operator will try to find the best fitting band.
...
op_bi2op <- function(
  ...
  xml_add_child(node, "operator", "Bi2Op")
