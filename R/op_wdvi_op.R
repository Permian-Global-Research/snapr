...
#' value. Default value is '1.0F'.
#' @param slopeSoilLine Soil line has an arbitrary slope and passes through
#' origin Default value is '1.5F'.
#' @param redSourceBand The red band for the WDVI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the WDVI computation. If not
...
#'
#' "Weighted Difference Vegetation Index retrieves the Isovegetation lines
#' parallel to soil line. Soil line has an arbitrary slope and passes through
#' origin"
#' @import xml2
#' @return snap_op_wdvi_op object
#' @export
op_wdvi_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "WdviOp")
