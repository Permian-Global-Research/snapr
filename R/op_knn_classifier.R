#' KNN-Classifier: snap operator function
...
#'
#' "K-Nearest Neighbour classifier Parameter Options: -PclassLevels=<int>
...
#' 'true'."
#' @import xml2
#' @return snap_op_knn_classifier object
#' @export
op_knn_classifier <- function(
    operator_id,
    sourceProduct,
    numNeighbours = 5,
  ...
  xml_add_child(node, "operator", "KNN-Classifier")
  ...
  snap_op_knn_classifier <- S7::new_class(
    "snap_op_knn_classifier",
    parent = snap_operator
  )
  snap_op_knn_classifier(
    operator = "KNN-Classifier",
