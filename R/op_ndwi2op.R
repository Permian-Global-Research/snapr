#' Ndwi2Op: snap operator function
...
#' value. Default value is '1.0F'.
#' @param greenSourceBand The green band for the NDWI2 computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the NDWI2 computation. If
...
#'
#' "The Normalized Difference Water Index, allowing for the measurement of
#' surface water extent"
#' @import xml2
#' @return snap_op_ndwi2op object
#' @export
op_ndwi2op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "Ndwi2Op")
