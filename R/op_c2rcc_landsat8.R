#' c2rcc.landsat8: snap operator function
...
#' Landsat-8 L1 data products."
#' @import xml2
#' @return snap_op_c2rcc_landsat8 object
#' @export
op_c2rcc_landsat8 <- function(
    operator_id,
    sourceProduct,
    ncepEndProduct = NULL,
  ...
  xml_add_child(node, "operator", "c2rcc.landsat8")
  ...
  snap_op_c2rcc_landsat8 <- S7::new_class(
    "snap_op_c2rcc_landsat8",
    parent = snap_operator
  )
  snap_op_c2rcc_landsat8(
    operator = "c2rcc.landsat8",
