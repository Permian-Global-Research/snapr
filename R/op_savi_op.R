...
#' value. Default value is '1.0F'.
#' @param soilCorrectionFactor The amount or cover of green vegetation. Default
#' value is '0.5F'.
#' @param redSourceBand The red band for the SAVI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the SAVI computation. If not
...
op_savi_op <- function(
  ...
  xml_add_child(node, "operator", "SaviOp")
