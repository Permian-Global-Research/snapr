...
#' value. Default value is '1.0F'.
#' @param mirSourceBand The mid-infrared band for the NDWI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the NDWI computation. If not
#' provided, the operator will try to find the best fitting band.
...
#'
#' "The Normalized Difference Water Index was developed for the extraction of
#' water features"
#' @import xml2
#' @return snap_op_ndwi_op object
#' @export
op_ndwi_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "NdwiOp")
