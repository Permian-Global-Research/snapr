...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the DVI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the DVI computation. If not
...
#'
#' "Difference Vegetation Index retrieves the Isovegetation lines parallel to
#' soil line"
#' @import xml2
#' @return snap_op_dvi_op object
#' @export
op_dvi_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "DviOp")
