#' Multi-Temporal-Speckle-Filter: snap operator function
...
#' @import xml2
#' @return snap_op_multi_temporal_speckle_filter object
#' @export
op_multi_temporal_speckle_filter <- function(
    operator_id,
    sourceProduct,
    sourceBands = NULL,
    filter = "Lee Sigma",
  ...
  xml_add_child(node, "operator", "Multi-Temporal-Speckle-Filter")
  ...
  snap_op_multi_temporal_speckle_filter <- S7::new_class(
    "snap_op_multi_temporal_speckle_filter",
