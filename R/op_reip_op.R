...
#' @param redSourceBand4 The red band (B4) for the REIP computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param redSourceBand5 The red band (B5) for the REIP computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param redSourceBand6 The red band (B6) for the REIP computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the REIP computation. If not
#' provided, the operator will try to find the best fitting band.
...
op_reip_op <- function(
  ...
  xml_add_child(node, "operator", "ReipOp")
