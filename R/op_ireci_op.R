#' IreciOp: snap operator function
...
#' @param redSourceBand4 The red band (B4) for the IRECI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param redSourceBand5 The red band (B5) for the IRECI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param redSourceBand6 The red band (B6) for the IRECI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the IRECI computation. If
...
#' @import xml2
#' @return snap_op_ireci_op object
#' @export
op_ireci_op <- function(
    operator_id,
    sourceProduct,
    resampleType = "None",
    redB4Factor = "1.0F",
  ...
  xml_add_child(node, "operator", "IreciOp")
