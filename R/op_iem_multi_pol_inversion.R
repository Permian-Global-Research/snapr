#' IEM-Multi-Pol-Inversion: snap operator function
...
#' @import xml2
#' @return snap_op_iem_multi_pol_inversion object
#' @export
op_iem_multi_pol_inversion <- function(
    operator_id,
    sourceProduct,
    N = 5,
    M = 5,
  ...
  xml_add_child(node, "operator", "IEM-Multi-Pol-Inversion")
  ...
  snap_op_iem_multi_pol_inversion <- S7::new_class(
    "snap_op_iem_multi_pol_inversion",
    parent = snap_operator
  )
  snap_op_iem_multi_pol_inversion(
    operator = "IEM-Multi-Pol-Inversion",
