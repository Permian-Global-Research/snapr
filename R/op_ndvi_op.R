...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the NDVI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the NDVI computation. If not
...
op_ndvi_op <- function(
  ...
  xml_add_child(node, "operator", "NdviOp")
