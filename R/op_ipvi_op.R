...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the IPVI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the IPVI computation. If not
...
#'
#' "Infrared Percentage Vegetation Index retrieves the Isovegetation lines
#' converge at origin"
#' @import xml2
#' @return snap_op_ipvi_op object
#' @export
op_ipvi_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "IpviOp")
