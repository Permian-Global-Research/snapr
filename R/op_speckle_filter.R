...
#' @param operator_sources character vector of operator sources that match
#' upstream `operator_id` values
...
op_speckle_filter <- function(
  ...
  xml_add_child(parameters, "sourceBandNames", gpt_args$sourceBandNames)
  xml_add_child(parameters, "filter", gpt_args$filter)
  xml_add_child(parameters, "filterSizeX", gpt_args$filterSizeX)
  xml_add_child(parameters, "filterSizeY", gpt_args$filterSizeY)
  xml_add_child(parameters, "dampingFactor", gpt_args$dampingFactor)
  xml_add_child(parameters, "estimateENL", gpt_args$estimateENL)
  xml_add_child(parameters, "enl", gpt_args$enl)
  xml_add_child(parameters, "numLooksStr", gpt_args$numLooksStr)
  xml_add_child(parameters, "windowSize", gpt_args$windowSize)
