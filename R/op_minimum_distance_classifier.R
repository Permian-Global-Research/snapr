#' Minimum-Distance-Classifier: snap operator function
...
#'
#' "Minimum Distance classifier Parameter Options: -PclassLevels=<int>
...
#' power set of features Default value is '2'. -PnumTrainSamples=<int> The number
#' of training samples Valid interval is (1,*\]. Default value is '5000'.
...
#' 'true'."
#' @import xml2
#' @return snap_op_minimum_distance_classifier object
#' @export
op_minimum_distance_classifier <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "Minimum-Distance-Classifier")
  ...
  snap_op_minimum_distance_classifier <- S7::new_class(
    "snap_op_minimum_distance_classifier",
    parent = snap_operator
  )
  snap_op_minimum_distance_classifier(
    operator = "Minimum-Distance-Classifier",
