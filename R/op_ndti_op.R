...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the NDTI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param greenSourceBand The green band for the NDTI computation. If not
...
#'
#' "Normalized difference turbidity index, allowing for the measurement of
#' water turbidity"
#' @import xml2
#' @return snap_op_ndti_op object
#' @export
op_ndti_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "NdtiOp")
