#' S2repOp: snap operator function
...
#' this value. Default value is '1.0F'.
#' @param redB6Factor The value of the red source band (B6) is multiplied by
#' this value. Default value is '1.0F'.
#' @param nirFactor The value of the NIR source band is multiplied by this
#' value. Default value is '1.0F'.
#' @param redSourceBand4 The red band (B4) for the S2REP computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param redSourceBand5 The red band (B5) for the S2REP computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param redSourceBand6 The red band (B6) for the S2REP computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the S2REP computation. If
...
#' @import xml2
#' @return snap_op_s2rep_op object
#' @export
op_s2rep_op <- function(
    operator_id,
    sourceProduct,
    resampleType = "None",
    redB4Factor = "1.0F",
  ...
  xml_add_child(node, "operator", "S2repOp")
