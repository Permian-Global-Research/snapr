...
#' @param redSourceBand4 The red band (B4) for the MTCI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param redSourceBand5 The red band (B5) for the MTCI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the MTCI computation. If not
#' provided, the operator will try to find the best fitting band.
...
#'
#' "The Meris Terrestrial Chlorophyll Index estimates the Red Edge Position
#' (REP)."
#' @import xml2
#' @return snap_op_mtci_op object
#' @export
op_mtci_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "MtciOp")
