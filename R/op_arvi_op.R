...
#' @param blueFactor The value of the BLUE source band is multiplied by this
#' value. Default value is '1.0F'.
#' @param nirFactor The value of the NIR source band is multiplied by this
#' value. Default value is '1.0F'.
#' @param gammaParameter The gamma parameter is like a weighting function that
#' depends on the aerosol type Default value is '1.0F'.
#' @param redSourceBand The red band for the ARVI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param blueSourceBand The blue band for the ARVI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the ARVI computation. If not
#' provided, the operator will try to find the best fitting band.
...
#'
#' "Atmospherically Resistant Vegetation Index belongs to a family of indices
#' with built-in atmospheric corrections."
#' @import xml2
#' @return snap_op_arvi_op object
#' @export
op_arvi_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "ArviOp")
