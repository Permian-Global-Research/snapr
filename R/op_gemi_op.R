...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the GEMI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the GEMI computation. If not
...
op_gemi_op <- function(
  ...
  xml_add_child(node, "operator", "GemiOp")
