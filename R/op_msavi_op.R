#' MsaviOp: snap operator function
...
#' @param redSourceBand The red band for the MSAVI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the MSAVI computation. If
...
#' @import xml2
#' @return snap_op_msavi_op object
#' @export
op_msavi_op <- function(
    operator_id,
    sourceProduct,
    resampleType = "None",
    redFactor = "1.0F",
  ...
  xml_add_child(node, "operator", "MsaviOp")
