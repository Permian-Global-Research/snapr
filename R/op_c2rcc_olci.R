#' c2rcc.olci: snap operator function
...
#' @param thresholdRtosaOOS Threshold for nn training dataset out of scope flag
#' for gas corrected top-of-atmosphere reflectances. Default value is '0.01'.
#' @param thresholdAcReflecOos Threshold for nn training dataset out of scope
#' flag for atmospherically corrected reflectances. Default value is '0.15'.
...
#' @param useEcmwfAuxData Use ECMWF auxiliary data (total_ozone,
#' sea_level_pressure) from the source product. Default value is 'true'.
...
#' SENTINEL-3 OLCI L1B data products."
#' @import xml2
#' @return snap_op_c2rcc_olci object
#' @export
op_c2rcc_olci <- function(
    operator_id,
    sourceProduct,
    ncepEndProduct = NULL,
  ...
  xml_add_child(node, "operator", "c2rcc.olci")
  ...
  snap_op_c2rcc_olci <- S7::new_class(
    "snap_op_c2rcc_olci",
