...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the BI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param greenSourceBand The green band for the BI computation. If not
...
#'
#' "The Brightness index represents the average of the brightness of a
#' satellite image."
#' @import xml2
#' @return snap_op_bi_op object
#' @export
op_bi_op <- function(
    operator_id,
    sourceProduct,
  ...
  xml_add_child(node, "operator", "BiOp")
