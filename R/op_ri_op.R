...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the RI computation. If not provided,
#' the operator will try to find the best fitting band.
#' @param greenSourceBand The green band for the RI computation. If not
...
op_ri_op <- function(
  ...
  xml_add_child(node, "operator", "RiOp")
