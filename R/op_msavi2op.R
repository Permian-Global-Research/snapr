#' Msavi2Op: snap operator function
...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the MSAVI2 computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the MSAVI2 computation. If
...
#'
#' "This retrieves the second Modified Soil Adjusted Vegetation Index
#' (MSAVI2)."
#' @import xml2
#' @return snap_op_msavi2op object
#' @export
op_msavi2op <- function(
    operator_id,
    sourceProduct,
    resampleType = "None",
    redFactor = "1.0F",
  ...
  xml_add_child(node, "operator", "Msavi2Op")
