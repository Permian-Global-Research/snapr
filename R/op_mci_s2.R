...
#' @param lineHeightBandName The name of the MCI band in the target product
...
#' @param invalidMciValue Value used to fill invalid MCI pixels Default value
#' is 'NaN'.
#' @details
...
op_mci_s2 <- function(
  ...
  xml_add_child(node, "operator", "Mci.s2")
  ...
  xml_add_child(
    parameters,
    "invalidMciValue",
    gpt_args$invalidMciValue
  )
  operator_sources <- gpt_args[c("sourceProduct")]
  snap_op_mci_s2 <- S7::new_class(
    "snap_op_mci_s2",
