#' TndviOp: snap operator function
...
#' value. Default value is '1.0F'.
#' @param redSourceBand The red band for the TNDVI computation. If not
#' provided, the operator will try to find the best fitting band.
#' @param nirSourceBand The near-infrared band for the TNDVI computation. If
...
#'
#' "Transformed Normalized Difference Vegetation Index retrieves the
#' Isovegetation lines parallel to soil line"
#' @import xml2
#' @return snap_op_tndvi_op object
#' @export
op_tndvi_op <- function(
    operator_id,
    sourceProduct,
    resampleType = "None",
    redFactor = "1.0F",
  ...
  xml_add_child(node, "operator", "TndviOp")
