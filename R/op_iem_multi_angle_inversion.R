#' IEM-Multi-Angle-Inversion: snap operator function
...
#' @param sigmaPol Multi-Angle Polarizations Value must be one of 'HH1-HH2',
#' 'HH1-VV2', 'VV1-VV2', 'VV1-HH2'. Default value is 'HH1-HH2'.
...
#' @import xml2
#' @return snap_op_iem_multi_angle_inversion object
#' @export
op_iem_multi_angle_inversion <- function(
    operator_id,
    sourceProduct,
    N = 5,
    M = 5,
  ...
  xml_add_child(node, "operator", "IEM-Multi-Angle-Inversion")
  ...
  snap_op_iem_multi_angle_inversion <- S7::new_class(
    "snap_op_iem_multi_angle_inversion",
    parent = snap_operator
  )
  snap_op_iem_multi_angle_inversion(
    operator = "IEM-Multi-Angle-Inversion",
